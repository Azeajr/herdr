...
fn api_method_name(method: &Method) -> &'static str {
    match method {
        ...
        Method::BrowserReload(_) => "browser.reload",
        Method::BrowserBack(_) => "browser.back",
        Method::BrowserForward(_) => "browser.forward",
        Method::BrowserInfo(_) => "browser.info",
        Method::BrowserClose(_) => "browser.close",
